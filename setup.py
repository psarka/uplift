#! /usr/bin/env python
#
# Copyright (C) 2007-2009 Paulius Sarka
...
class CleanCommand(Clean):
    ...
    def run(self):
        ...
        if os.path.exists('build'):
            shutil.rmtree('build')
        for dirpath, dirnames, filenames in os.walk('uplift'):
...
def setup_package():
    ...
    if len(sys.argv) == 1 or (
        ...
        numpy_req_str = "uplift requires NumPy >= {0}.\n".format(
            numpy_min_version)
        scipy_status = get_scipy_status()
        scipy_req_str = "uplift requires SciPy >= {0}.\n".format(
            scipy_min_version)
